from src.app.services.nosqlConnection import NoSQLConnectionManager as cm, NoSQLSchemaManager as sm
...
def create_nosql_objects(handle):
    ...
    create_general_content_doc = """
    CREATE TABLE IF NOT EXISTS GeneralDocumentsContent (
        content_id INTEGER,
        content_details JSON,
        file_name STRING,
        product_name STRING,
    ...
    general_doc_content_index1 = """
    CREATE INDEX IF NOT EXISTS idx_proj_support_docs ON GeneralDocumentsContent (
        content_id,
        questions_generated
    )
    """
    ...
    sm.create_table(handle, create_general_content_doc, 'GeneralDocumentsContent', read_units=50, write_units=10, storage_gb=2)
    ...
    sm.create_index(handle, general_doc_content_index1)
