...
from chatPackages.imgStringExtract import GoogleVisionOCR as gv
...
class PDFProcessing:
    ...
    @classmethod
    def get_pdf_string(cls, file_path, conn, logger, data_end_str=None, pages_range=None, img_flg=True):
        ...
        with ThreadPoolExecutor(max_workers=5) as executor:
            ...
            for i, img in enumerate(pdf_images):
                future = executor.submit(gv.get_string, img, False, conn, logger, data_end_str, i)
